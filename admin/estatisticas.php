  ...
  <main class="admin-content">
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1rem;margin-bottom:1.5rem;">
      ...
      <form method="GET" style="display:flex;align-items:center;gap:.5rem;flex-wrap:wrap;">
        ...
        <select name="ano" style="padding:.45rem .75rem;border:1.5px solid var(--creme-escuro);border-radius:8px;background:var(--creme);font-size:.9rem;color:var(--texto);">
    ...
    <div class="admin-rankings-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:1.5rem;">
    ...
    <div class="admin-rankings-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;">
