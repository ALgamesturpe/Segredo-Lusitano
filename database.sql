...
CREATE TABLE utilizadores (
    ...
    termos_aceites_em DATETIME     DEFAULT NULL,
    pais_registo      VARCHAR(100) DEFAULT NULL,
    regiao_registo    VARCHAR(100) DEFAULT NULL,
    cidade_registo    VARCHAR(100) DEFAULT NULL,
...
-- O email é usado para impedir novo registo.
-- ============================================================
...
CREATE TABLE mensagens (
    ...
    apagada_por_receptor TINYINT(1)   DEFAULT 0,
    apagada_para_todos   TINYINT(1)   DEFAULT 0,
    criado_em            DATETIME     DEFAULT CURRENT_TIMESTAMP,
...
-- Utilizador fantasma (ID: 1) — conteúdo de contas eliminadas
...
-- Conta do Administrador (ID: 2)  |  password: admin123
...
INSERT INTO utilizadores (id, nome, username, email, password, bio, pontos, role, ativo, verificado, criado_em) VALUES
  ...
  (4, 'Martí Díez',     'username_marti',   'tiago@exemplo.pt',   '$2y$12$8K4ZmJP1qXhRfYvT3.uW6e9LkW8aD/Hn7zVc1bJqGfMxNp2sR3oYS', 'Fotógrafo amador à procura dos cantos escondidos do país.',  210, 'user', 1, 1, NOW() - INTERVAL 80 DAY),
...
-- regioes: 1=Norte  2=Centro  3=Sul  4=Açores  5=Madeira
-- ============================================================
INSERT INTO locais (utilizador_id, categoria_id, regiao_id, nome, descricao, latitude, longitude, dificuldade, foto_capa, estado, vistas, criado_em) VALUES
  (3, 1, 1, 'Cascata da Fervença',
   'Escondida na Serra d''Arga, a Cascata da Fervença é uma das quedas de água mais impressionantes do Minho. As águas frias formam piscinas naturais ideais para um mergulho refrescante no verão, num cenário rodeado de vegetação luxuriante.',
   41.8500000, -8.6833000, 'medio', 'cascata_fervenca.jpeg', 'aprovado', 87, NOW() - INTERVAL 45 DAY),

  (3, 3, 1, 'Rio de Onor',
   'Aldeia única no concelho de Bragança, partilhada entre Portugal e Espanha, onde a fronteira passa literalmente no meio da povoação. Conhecida pelo seu sistema comunitário ancestral e pelas casas tradicionais em xisto, é um verdadeiro tesouro vivo de Trás-os-Montes.',
   41.9408000, -6.6072000, 'facil', 'rio_de_onor.jpeg', 'aprovado', 142, NOW() - INTERVAL 6 DAY),

  (6, 2, 2, 'Miradouro de Casal de São Simão',
   'Aldeia de xisto pousada sobre uma encosta com vista deslumbrante sobre o vale do Alge. O miradouro oferece um dos mais belos panoramas do interior de Portugal, especialmente ao pôr do sol quando as pedras de xisto ganham tons dourados.',
   39.9667000, -8.3833000, 'facil', 'miradouro_casal_sao_simao.jpeg', 'aprovado', 56, NOW() - INTERVAL 4 DAY),

  (6, 3, 2, 'Aldeia Histórica de Piódão',
   'Considerada uma das aldeias mais bonitas de Portugal, Piódão é conhecida pelas suas casas em xisto com portas e janelas pintadas de azul, dispostas em forma de presépio na encosta da serra. Faz parte das Aldeias Históricas de Portugal.',
   40.2333000, -7.8167000, 'medio', 'piodao.jpeg', 'aprovado', 312, NOW() - INTERVAL 42 DAY),

  (5, 1, 3, 'Pego do Inferno',
   'Apesar do nome assustador, o Pego do Inferno é um paraíso escondido em Tavira. Uma cascata cristalina cai numa lagoa de águas turquesa, rodeada por vegetação densa. Local mágico para escapar ao calor do Algarve.',
   37.1500000, -7.6500000, 'medio', 'pego_do_inferno.jpeg', 'aprovado', 215, NOW() - INTERVAL 32 DAY),

  (4, 5, 2, 'Praia Fluvial do Penedo Furado',
   'Uma das praias fluviais mais bonitas de Portugal, no concelho de Vila de Rei. As águas calmas do rio Zêzere e o pequeno tobogã natural na rocha tornam este local perfeito para um dia em família. Atravessa uma ponte suspensa para chegar à praia.',
   39.6833000, -8.1500000, 'facil', 'penedo_furado.jpeg', 'aprovado', 198, NOW() - INTERVAL 13 DAY),

  (4, 7, 2, 'Grutas de Mira de Aire',
   'As maiores grutas turísticas de Portugal, descobertas em 1947 no concelho de Porto de Mós. Com 11 km de extensão (apenas 600m abertos ao público), oferecem um espetáculo natural de estalactites, estalagmites e lagos subterrâneos iluminados.',
   39.5333000, -8.7333000, 'facil', 'grutas_mira_aire.jpeg', 'aprovado', 267, NOW() - INTERVAL 9 DAY),

  (4, 6, 2, 'Mata Nacional do Buçaco',
   'Floresta sagrada onde os monges Carmelitas Descalços plantaram espécies vindas de todo o mundo no século XVII. O Buçaco esconde fontes, capelas, ermidas e o famoso Palace Hotel num cenário de conto de fadas, rodeado de árvores centenárias.',
   40.3833000, -8.3667000, 'facil', 'mata_bucaco.jpeg', 'aprovado', 178, NOW() - INTERVAL 20 DAY),

  (7, 8, 3, 'Convento dos Capuchos',
   'Convento franciscano do século XVI escondido na Serra de Sintra, conhecido pela extrema pobreza e simplicidade das suas celas, algumas revestidas a cortiça. Considerado um dos lugares mais místicos e introspetivos de Portugal.',
   38.7833000, -9.4500000, 'facil', 'convento_capuchos.jpeg', 'aprovado', 145, NOW() - INTERVAL 2 DAY),

  (7, 5, 3, 'Praia da Adraga',
   'Praia selvagem rodeada de imponentes falésias na costa de Sintra. As suas grutas, arcos naturais e areia dourada fazem dela uma das praias mais cinematográficas de Portugal. Ao pôr do sol, o espetáculo é inesquecível.',
   38.8000000, -9.4833000, 'medio', 'praia_adraga.jpeg', 'aprovado', 234, NOW() - INTERVAL 35 DAY),

  (7, 2, 3, 'Cabo Espichel',
   'Promontório dramático no extremo sul da Península de Setúbal, com falésias abruptas a cair sobre o oceano. O Santuário de Nossa Senhora do Cabo, o farol e a vista infinita sobre o Atlântico fazem deste um dos miradouros mais espetaculares do país.',
   38.4167000, -9.2167000, 'facil', 'cabo_espichel.jpeg', 'aprovado', 189, NOW() - INTERVAL 7 DAY),

  (8, 3, 3, 'Aldeia de Monsaraz',
   'Vila medieval murada no topo de uma colina com vista panorâmica sobre o Alqueva, o maior lago artificial da Europa. As ruas calcetadas, as casas brancas e o castelo do século XIII transportam o visitante de volta à Idade Média.',
   38.4417000, -7.3789000, 'facil', 'monsaraz.png', 'aprovado', 287, NOW() - INTERVAL 45 DAY),

  (8, 4, 3, 'Ruínas de Miróbriga',
   'Antiga cidade romana no concelho de Santiago do Cacém, com mais de 2000 anos de história. Conserva o fórum, o hipódromo (único na Península Ibérica) e as termas, oferecendo uma viagem fascinante pela vida quotidiana do Império Romano.',
   38.0167000, -8.6833000, 'facil', 'mirobriga.jpeg', 'aprovado', 96, NOW() - INTERVAL 14 DAY),

  (5, 5, 3, 'Praia da Marinha',
   'Considerada uma das 10 praias mais bonitas do mundo pela revista Condé Nast Traveler. As formações rochosas em forma de M, as águas turquesa e as falésias douradas fazem desta a imagem postal mais icónica do Algarve.',
   37.0900000, -8.4150000, 'medio', 'praia_marinha.jpeg', 'aprovado', 421, NOW() - INTERVAL 70 DAY),

  (5, 8, 3, 'Forte de São João do Arade',
   'Fortaleza do século XVII na foz do rio Arade, em Ferragudo. Construída para defender Portimão dos ataques de piratas, é hoje propriedade privada e funciona como cenário emblemático sobre as águas. Vista incrível ao pôr do sol vista da praia da Angrinha.',
   37.1233000, -8.5275000, 'facil', 'forte_sao_joao_arade.jpeg', 'aprovado', 134, NOW() - INTERVAL 12 DAY);

-- ============================================================
-- LIKES
-- ============================================================
INSERT INTO likes (local_id, utilizador_id, criado_em) VALUES
  (1, 2, NOW() - INTERVAL 40 DAY), (1, 4, NOW() - INTERVAL 35 DAY),
  (1, 5, NOW() - INTERVAL 20 DAY), (1, 7, NOW() - INTERVAL 10 DAY),

  (2, 2, NOW() - INTERVAL 35 DAY), (2, 4, NOW() - INTERVAL 32 DAY),
  (2, 5, NOW() - INTERVAL 28 DAY), (2, 6, NOW() - INTERVAL 22 DAY),
  (2, 8, NOW() - INTERVAL 15 DAY),

  (3, 2, NOW() - INTERVAL 25 DAY), (3, 3, NOW() - INTERVAL 20 DAY),
  (3, 7, NOW() - INTERVAL 12 DAY),

  (4, 2, NOW() - INTERVAL 55 DAY), (4, 3, NOW() - INTERVAL 50 DAY),
  (4, 4, NOW() - INTERVAL 45 DAY), (4, 5, NOW() - INTERVAL 40 DAY),
  (4, 7, NOW() - INTERVAL 35 DAY), (4, 8, NOW() - INTERVAL 30 DAY),

  (5, 2, NOW() - INTERVAL 50 DAY), (5, 3, NOW() - INTERVAL 45 DAY),
  (5, 4, NOW() - INTERVAL 40 DAY), (5, 6, NOW() - INTERVAL 35 DAY),
  (5, 7, NOW() - INTERVAL 28 DAY), (5, 8, NOW() - INTERVAL 22 DAY),

  (6, 2, NOW() - INTERVAL 38 DAY), (6, 3, NOW() - INTERVAL 32 DAY),
  (6, 5, NOW() - INTERVAL 25 DAY), (6, 7, NOW() - INTERVAL 18 DAY),
  (6, 8, NOW() - INTERVAL 10 DAY),

  (7, 2, NOW() - INTERVAL 22 DAY), (7, 3, NOW() - INTERVAL 18 DAY),
  (7, 5, NOW() - INTERVAL 15 DAY), (7, 6, NOW() - INTERVAL 12 DAY),
  (7, 7, NOW() - INTERVAL 10 DAY), (7, 8, NOW() - INTERVAL 8 DAY),

  (8, 2, NOW() - INTERVAL 18 DAY), (8, 3, NOW() - INTERVAL 15 DAY),
  (8, 5, NOW() - INTERVAL 12 DAY), (8, 6, NOW() - INTERVAL 8 DAY),
  (8, 8, NOW() - INTERVAL 5 DAY),

  (9, 2, NOW() - INTERVAL 30 DAY), (9, 3, NOW() - INTERVAL 25 DAY),
  (9, 4, NOW() - INTERVAL 20 DAY), (9, 5, NOW() - INTERVAL 15 DAY),
  (9, 6, NOW() - INTERVAL 10 DAY),

  (10, 2, NOW() - INTERVAL 45 DAY), (10, 3, NOW() - INTERVAL 40 DAY),
  (10, 4, NOW() - INTERVAL 35 DAY), (10, 5, NOW() - INTERVAL 30 DAY),
  (10, 6, NOW() - INTERVAL 22 DAY), (10, 8, NOW() - INTERVAL 15 DAY),

  (11, 2, NOW() - INTERVAL 25 DAY), (11, 3, NOW() - INTERVAL 22 DAY),
  (11, 4, NOW() - INTERVAL 18 DAY), (11, 5, NOW() - INTERVAL 14 DAY),
  (11, 6, NOW() - INTERVAL 10 DAY),

  (12, 2, NOW() - INTERVAL 60 DAY), (12, 3, NOW() - INTERVAL 55 DAY),
  (12, 4, NOW() - INTERVAL 50 DAY), (12, 5, NOW() - INTERVAL 45 DAY),
  (12, 6, NOW() - INTERVAL 40 DAY), (12, 7, NOW() - INTERVAL 30 DAY),

  (13, 2, NOW() - INTERVAL 15 DAY), (13, 4, NOW() - INTERVAL 12 DAY),
  (13, 7, NOW() - INTERVAL 8 DAY),

  (14, 2, NOW() - INTERVAL 65 DAY), (14, 3, NOW() - INTERVAL 60 DAY),
  (14, 4, NOW() - INTERVAL 55 DAY), (14, 6, NOW() - INTERVAL 50 DAY),
  (14, 7, NOW() - INTERVAL 45 DAY), (14, 8, NOW() - INTERVAL 40 DAY),

  (15, 2, NOW() - INTERVAL 10 DAY), (15, 4, NOW() - INTERVAL 8 DAY),
  (15, 7, NOW() - INTERVAL 6 DAY),  (15, 8, NOW() - INTERVAL 4 DAY);
